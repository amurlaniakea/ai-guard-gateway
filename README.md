...
- **Detección de Inyección de Prompt**: Bloqueo nativo de patrones de ataque comunes (Jailbreaks, System Overrides).
  **Estado Actual:** Prototipo en fase de hardening. Tasa de bloqueo actual: **68%** (FPR: 5%) sobre benchmark interno. Ver [tasks.md](tasks.md) para el roadmap de mejora y limitaciones conocidas.
