...
- **Logging Estructurado**: Salida de logs en formato JSON lista para integración con ELK o Grafana Loki.
- **Health Checks**: Endpoints de estado para orquestadores como Kubernetes.
